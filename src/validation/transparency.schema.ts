...
export type TransparencyInput = z.infer<typeof createTransparencySchema>;
...
export const getPaginatedTransparencySchema = paginationSchema.merge(transparencyFilterSchema);
