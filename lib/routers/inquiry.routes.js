...
router.post("/", rate_limiter_1.contactLimiter, (0, multipart_busboy_1.multipartBusboy)({
    maxFiles: 1,
...
router.patch("/toggleReadStatus/:id", auth_1.requireAdmin, (0, validate_1.validateParams)(id_schema_1.idSchema), inquiry_1.toggleReadStatusController);
router.patch("/markAllAsRead", auth_1.requireAdmin, (0, validate_1.validateBody)(id_schema_1.idsSchema), inquiry_1.markAllAsReadController);
router.delete("/bulkDelete", auth_1.requireAdmin, (0, validate_1.validateBody)(id_schema_1.idsSchema), inquiry_1.bulkDeleteInquiriesController);
router.delete("/:id", auth_1.requireAdmin, (0, validate_1.validateParams)(id_schema_1.idSchema), auth_1.requireAdmin, inquiry_1.deleteInquiryController);
