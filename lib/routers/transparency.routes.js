...
router.get("/count", middleware_1.requireAdmin, (0, validate_1.validateQuery)(transparency_schema_1.getTotalTransparencyCountSchema), transparency_1.getTotalTransparencyCountController);
...
router.get("/count-this-year", middleware_1.requireAdmin, transparency_1.getTransparencyCountThisYearController);
// private routes
