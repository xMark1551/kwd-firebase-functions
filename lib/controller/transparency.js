...
exports.createTransparencyController = (0, handler_1.asyncHandler)(async (req, res) => {
    ...
    await transparency_service_1.transparencyService.createTransparency(user, data, fileToUpload);
    res.status(200).json({
        ok: true,
    });
});
...
exports.patchTransparencyController = (0, handler_1.asyncHandler)(async (req, res) => {
    ...
    const data = req.body;
    const fileToUpload = req.filesToUpload[0];
    await transparency_service_1.transparencyService.patchTransparency(id, data, fileToUpload);
    res.status(200).json({
        ok: true,
    });
});
exports.patchTransparencyFolderController = (0, handler_1.asyncHandler)(async (req, res) => {
    const { id } = req.params;
    const data = req.body;
    await transparency_service_1.transparencyService.updateTransparencyFolder(id, data);
    res.status(200).json({
        ok: true,
    });
});
exports.deleteTransparencyController = (0, handler_1.asyncHandler)(async (req, res) => {
    const { id } = req.params;
    await transparency_service_1.transparencyService.deleteTransparency(id);
    res.status(200).json({
        ok: true,
    });
});
exports.bulkDeleteTransparencyController = (0, handler_1.asyncHandler)(async (req, res) => {
    const ids = req.body;
    await transparency_service_1.transparencyService.bulkDeleteTransparency(ids);
    res.status(200).json({
        ok: true,
    });
});
exports.deleteTransparencyFolderController = (0, handler_1.asyncHandler)(async (req, res) => {
    const { id } = req.params;
    await transparency_service_1.transparencyService.deleteTransparencyFolder(id);
    res.status(200).json({
        ok: true,
    });
});
