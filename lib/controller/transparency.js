...
exports.createTransparencyFolderController = (0, handler_1.asyncHandler)(async (req, res) => {
    const data = req.body;
    const response = await transparency_service_1.transparencyService.createTransparencyFolder(data);
...
exports.getTotalTransparencyCountController = (0, handler_1.asyncHandler)(async (req, res) => {
    ...
    (0, reponse_1.ok)(res, response, "Transparency total count fetched");
});
