...
const callable_wrapper_1 = require("../utils/callable.wrapper");
...
exports.createNewsCallable = (0, https_1.onCall)((0, callable_wrapper_1.callableWrapper)(async ({ dataWithAuthorId }) => {
    // console.log("test data SAMPLEss", dataWithAuthorId.category);
    console.log("sample payload", dataWithAuthorId.category);
    // return await createPost(finalData);
}, { requireAuth: true, requireAdmin: true, validateForm: { schema: post_schema_1.postSchema } }));
